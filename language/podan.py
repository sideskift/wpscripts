...
def translate_po_file(input_file, output_file):
    ...
    # Make a Google transalate object instance. 
    # TODO: Avoid hard coded languages. 
    translator = GoogleTranslator(source='en', target='da')
    
    # TODO: Avoid using print, find a better way of logging. 
    print(f"Found {len(po)} strings to translate")
    
    # Translate each untranslated entry
    # TODO: What is tqdm? - Propable the progress bar..
    ...
    # TODO: avoid print, get a better logging system. 
...
def main() -> Literal[1] | Literal[0]:
    """
    Main method called if this module file is executed directly. 

    Returns:
        Literal[1] | Literal[0]: Returns 0 if OK, 1 if error. 
    """
    ...
    # TODO : Better log writing - avoid print. 
